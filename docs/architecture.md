...
Основные сущности: `categories`, `products`, `product_images`, `media`, `posts` (новости), `delivery_methods`, `payment_methods`, `orders`, `order_items`, `payments`, `users`, `admin_users`, `roles`, `outbox`.
